    ...
    try {
      ...
      if (res && !res.message) {
        ...
        if (res.message === "startup not found") {
          setError(
            <p>
              Startup with the provided DPIIT ID not found, Enter valid DPIIT ID
              or{" "}
              <NavLink
          ...
          <div className="flex flex-col items-center justify-center gap-2 sm:gap-4">
            ...
            <div className="flex items-center flex-col justify-center gap-3">
              ...
              <p className="text-xs xs:text-sm text-md text-center text-[#2f2f2f] md:px-6">
                Please wait while we verify your startup DPIIT recognition
                License.
              </p>
            </div>
          </div>
      ...
      {data && (
        <div className="w-full max-w-xl m-8 bg-[#f9f9f9] rounded-lg shadow-md p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
            ...
            {/* Address Section */}
            <div className="space-y-2">
              <h3 className="font-medium text-[#f68533]">Address</h3>
              <div>
                <strong>Address:</strong> {data.address}
              </div>
              <div>
                <strong>City/District:</strong> {data.district}, {data.state}
              </div>
              <div>
            ...
            {/* Bank Info Section */}
            <div className="space-y-2">
              <h3 className="font-medium text-[#f68533]">Bank Information</h3>
              <div>
            ...
            <div className="space-y-2">
              <h3 className="font-medium text-[#f68533]">Other Information</h3>
              <div>
              ...
              <div>
                <strong>Confirm Email:</strong> {data.confirmEmailAddress}
              </div>
              <div>
                <strong>Confirm Mobile:</strong> {data.confirmMobile}
              </div>
              <div>
                <strong>Balance Statement:</strong> {data.balanceStatement}
              </div>
            </div>
          </div>
            ...
            <Button
              ...
              btnText={
                <div className="flex items-center justify-center gap-2">
                  <p className="text-[#f9f9f9]">Proceed with Above Details</p>
                  <div className="size-[14px] fill-[#f9f9f9]">{icons.next}</div>
                </div>
              }
