  ...
  return (
    <div className="w-full px-[5%] py-8">
      ...
      <motion.p
        ...
        viewport={{ once: true, amount: 0.2 }}
      >
        Discover a wide range of healthcare and wellness services offered by
        AYUSH, empowering individuals through traditional and holistic health
        practices.
      </motion.p>
      <hr className="my-6" />
      <motion.section
      ...
      >
        ...
        <p className="text-md text-center text-gray-600 mb-4">
          Whether you're new to AYUSH or a healthcare professional, our services
          are designed to help you explore holistic health practices and improve
          your well-being.
        </p>
